...
import { MessageType, ProductEvent, TOPIC_TYPE } from "../../types";

// configuration properties
const CLIENT_ID = process.env.CLIENT_ID ?? "product-service";
const GROUP_ID = process.env.GROUP_ID ?? "product-service-group";
